  ...
  return (
    <div className="min-h-screen bg-neutral-50 pb-20">
      ...
      <Dialog open={showDerivacion} onOpenChange={setShowDerivacion}>
        <DialogContent className="sm:max-w-[680px] bg-white rounded-t-2xl sm:rounded-2xl border-t-8 border-brand-600 p-0 overflow-hidden outline-none flex flex-col relative">
